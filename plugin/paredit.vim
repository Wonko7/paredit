...
function! PareditInitBuffer()
    ...
    if g:paredit_mode
        ...
        nnoremap <buffer> <silent> ci"          :<C-U>call PareditChangeSpec('ci"',1)<CR>
        nnoremap <buffer> <silent> ca"          :<C-U>call PareditChangeSpec('ca"',1)<CR>
        nnoremap <buffer> <silent> c%           :<C-U>call feedkeys('c%','n')<CR>

        nnoremap <buffer> <silent> c,           :<C-U>call feedkeys('c,','n')<CR>
        nnoremap <buffer> <silent> c;           :<C-U>call feedkeys('c;','n')<CR>

        " ascii (range 33 127)
        nnoremap <buffer> <silent> ct!           :<C-U>call feedkeys('ct!','n')<CR>
        nnoremap <buffer> <silent> cT!           :<C-U>call feedkeys('cT!','n')<CR>
        nnoremap <buffer> <silent> cf!           :<C-U>call feedkeys('cf!','n')<CR>
        nnoremap <buffer> <silent> cF!           :<C-U>call feedkeys('cF!','n')<CR>
        nnoremap <buffer> <silent> ct"           :<C-U>call feedkeys('ct"','n')<CR>
        nnoremap <buffer> <silent> cT"           :<C-U>call feedkeys('cT"','n')<CR>
        nnoremap <buffer> <silent> cf"           :<C-U>call feedkeys('cf"','n')<CR>
        ...
        nnoremap <buffer> <silent> cf/           :<C-U>call feedkeys('cf/','n')<CR>
        nnoremap <buffer> <silent> cF/           :<C-U>call feedkeys('cF/','n')<CR>
        nnoremap <buffer> <silent> ct0           :<C-U>call feedkeys('ct0','n')<CR>
        nnoremap <buffer> <silent> cT0           :<C-U>call feedkeys('cT0','n')<CR>
        nnoremap <buffer> <silent> cf0           :<C-U>call feedkeys('cf0','n')<CR>
        nnoremap <buffer> <silent> cF0           :<C-U>call feedkeys('cF0','n')<CR>
        nnoremap <buffer> <silent> ct1           :<C-U>call feedkeys('ct1','n')<CR>
        nnoremap <buffer> <silent> cT1           :<C-U>call feedkeys('cT1','n')<CR>
        nnoremap <buffer> <silent> cf1           :<C-U>call feedkeys('cf1','n')<CR>
        nnoremap <buffer> <silent> cF1           :<C-U>call feedkeys('cF1','n')<CR>
        nnoremap <buffer> <silent> ct2           :<C-U>call feedkeys('ct2','n')<CR>
        nnoremap <buffer> <silent> cT2           :<C-U>call feedkeys('cT2','n')<CR>
        nnoremap <buffer> <silent> cf2           :<C-U>call feedkeys('cf2','n')<CR>
        nnoremap <buffer> <silent> cF2           :<C-U>call feedkeys('cF2','n')<CR>
        nnoremap <buffer> <silent> ct3           :<C-U>call feedkeys('ct3','n')<CR>
        nnoremap <buffer> <silent> cT3           :<C-U>call feedkeys('cT3','n')<CR>
        nnoremap <buffer> <silent> cf3           :<C-U>call feedkeys('cf3','n')<CR>
        nnoremap <buffer> <silent> cF3           :<C-U>call feedkeys('cF3','n')<CR>
        nnoremap <buffer> <silent> ct4           :<C-U>call feedkeys('ct4','n')<CR>
        nnoremap <buffer> <silent> cT4           :<C-U>call feedkeys('cT4','n')<CR>
        nnoremap <buffer> <silent> cf4           :<C-U>call feedkeys('cf4','n')<CR>
        nnoremap <buffer> <silent> cF4           :<C-U>call feedkeys('cF4','n')<CR>
        nnoremap <buffer> <silent> ct5           :<C-U>call feedkeys('ct5','n')<CR>
        nnoremap <buffer> <silent> cT5           :<C-U>call feedkeys('cT5','n')<CR>
        nnoremap <buffer> <silent> cf5           :<C-U>call feedkeys('cf5','n')<CR>
        nnoremap <buffer> <silent> cF5           :<C-U>call feedkeys('cF5','n')<CR>
        nnoremap <buffer> <silent> ct6           :<C-U>call feedkeys('ct6','n')<CR>
        nnoremap <buffer> <silent> cT6           :<C-U>call feedkeys('cT6','n')<CR>
        nnoremap <buffer> <silent> cf6           :<C-U>call feedkeys('cf6','n')<CR>
        nnoremap <buffer> <silent> cF6           :<C-U>call feedkeys('cF6','n')<CR>
        nnoremap <buffer> <silent> ct7           :<C-U>call feedkeys('ct7','n')<CR>
        nnoremap <buffer> <silent> cT7           :<C-U>call feedkeys('cT7','n')<CR>
        nnoremap <buffer> <silent> cf7           :<C-U>call feedkeys('cf7','n')<CR>
        nnoremap <buffer> <silent> cF7           :<C-U>call feedkeys('cF7','n')<CR>
        nnoremap <buffer> <silent> ct8           :<C-U>call feedkeys('ct8','n')<CR>
        nnoremap <buffer> <silent> cT8           :<C-U>call feedkeys('cT8','n')<CR>
        nnoremap <buffer> <silent> cf8           :<C-U>call feedkeys('cf8','n')<CR>
        nnoremap <buffer> <silent> cF8           :<C-U>call feedkeys('cF8','n')<CR>
        nnoremap <buffer> <silent> ct9           :<C-U>call feedkeys('ct9','n')<CR>
        nnoremap <buffer> <silent> cT9           :<C-U>call feedkeys('cT9','n')<CR>
        nnoremap <buffer> <silent> cf9           :<C-U>call feedkeys('cf9','n')<CR>
        nnoremap <buffer> <silent> cF9           :<C-U>call feedkeys('cF9','n')<CR>
        nnoremap <buffer> <silent> ct:           :<C-U>call feedkeys('ct:','n')<CR>
        nnoremap <buffer> <silent> cT:           :<C-U>call feedkeys('cT:','n')<CR>
        nnoremap <buffer> <silent> cf:           :<C-U>call feedkeys('cf:','n')<CR>
        ...
        nnoremap <buffer> <silent> cf@           :<C-U>call feedkeys('cf@','n')<CR>
        nnoremap <buffer> <silent> cF@           :<C-U>call feedkeys('cF@','n')<CR>
        nnoremap <buffer> <silent> ctA           :<C-U>call feedkeys('ctA','n')<CR>
        nnoremap <buffer> <silent> cTA           :<C-U>call feedkeys('cTA','n')<CR>
        nnoremap <buffer> <silent> cfA           :<C-U>call feedkeys('cfA','n')<CR>
        nnoremap <buffer> <silent> cFA           :<C-U>call feedkeys('cFA','n')<CR>
        nnoremap <buffer> <silent> ctB           :<C-U>call feedkeys('ctB','n')<CR>
        nnoremap <buffer> <silent> cTB           :<C-U>call feedkeys('cTB','n')<CR>
        nnoremap <buffer> <silent> cfB           :<C-U>call feedkeys('cfB','n')<CR>
        nnoremap <buffer> <silent> cFB           :<C-U>call feedkeys('cFB','n')<CR>
        nnoremap <buffer> <silent> ctC           :<C-U>call feedkeys('ctC','n')<CR>
        nnoremap <buffer> <silent> cTC           :<C-U>call feedkeys('cTC','n')<CR>
        nnoremap <buffer> <silent> cfC           :<C-U>call feedkeys('cfC','n')<CR>
        nnoremap <buffer> <silent> cFC           :<C-U>call feedkeys('cFC','n')<CR>
        nnoremap <buffer> <silent> ctD           :<C-U>call feedkeys('ctD','n')<CR>
        nnoremap <buffer> <silent> cTD           :<C-U>call feedkeys('cTD','n')<CR>
        nnoremap <buffer> <silent> cfD           :<C-U>call feedkeys('cfD','n')<CR>
        nnoremap <buffer> <silent> cFD           :<C-U>call feedkeys('cFD','n')<CR>
        nnoremap <buffer> <silent> ctE           :<C-U>call feedkeys('ctE','n')<CR>
        nnoremap <buffer> <silent> cTE           :<C-U>call feedkeys('cTE','n')<CR>
        nnoremap <buffer> <silent> cfE           :<C-U>call feedkeys('cfE','n')<CR>
        nnoremap <buffer> <silent> cFE           :<C-U>call feedkeys('cFE','n')<CR>
        nnoremap <buffer> <silent> ctF           :<C-U>call feedkeys('ctF','n')<CR>
        nnoremap <buffer> <silent> cTF           :<C-U>call feedkeys('cTF','n')<CR>
        nnoremap <buffer> <silent> cfF           :<C-U>call feedkeys('cfF','n')<CR>
        nnoremap <buffer> <silent> cFF           :<C-U>call feedkeys('cFF','n')<CR>
        nnoremap <buffer> <silent> ctG           :<C-U>call feedkeys('ctG','n')<CR>
        nnoremap <buffer> <silent> cTG           :<C-U>call feedkeys('cTG','n')<CR>
        nnoremap <buffer> <silent> cfG           :<C-U>call feedkeys('cfG','n')<CR>
        nnoremap <buffer> <silent> cFG           :<C-U>call feedkeys('cFG','n')<CR>
        nnoremap <buffer> <silent> ctH           :<C-U>call feedkeys('ctH','n')<CR>
        nnoremap <buffer> <silent> cTH           :<C-U>call feedkeys('cTH','n')<CR>
        nnoremap <buffer> <silent> cfH           :<C-U>call feedkeys('cfH','n')<CR>
        nnoremap <buffer> <silent> cFH           :<C-U>call feedkeys('cFH','n')<CR>
        nnoremap <buffer> <silent> ctI           :<C-U>call feedkeys('ctI','n')<CR>
        nnoremap <buffer> <silent> cTI           :<C-U>call feedkeys('cTI','n')<CR>
        nnoremap <buffer> <silent> cfI           :<C-U>call feedkeys('cfI','n')<CR>
        nnoremap <buffer> <silent> cFI           :<C-U>call feedkeys('cFI','n')<CR>
        nnoremap <buffer> <silent> ctJ           :<C-U>call feedkeys('ctJ','n')<CR>
        nnoremap <buffer> <silent> cTJ           :<C-U>call feedkeys('cTJ','n')<CR>
        nnoremap <buffer> <silent> cfJ           :<C-U>call feedkeys('cfJ','n')<CR>
        nnoremap <buffer> <silent> cFJ           :<C-U>call feedkeys('cFJ','n')<CR>
        nnoremap <buffer> <silent> ctK           :<C-U>call feedkeys('ctK','n')<CR>
        nnoremap <buffer> <silent> cTK           :<C-U>call feedkeys('cTK','n')<CR>
        nnoremap <buffer> <silent> cfK           :<C-U>call feedkeys('cfK','n')<CR>
        nnoremap <buffer> <silent> cFK           :<C-U>call feedkeys('cFK','n')<CR>
        nnoremap <buffer> <silent> ctL           :<C-U>call feedkeys('ctL','n')<CR>
        nnoremap <buffer> <silent> cTL           :<C-U>call feedkeys('cTL','n')<CR>
        nnoremap <buffer> <silent> cfL           :<C-U>call feedkeys('cfL','n')<CR>
        nnoremap <buffer> <silent> cFL           :<C-U>call feedkeys('cFL','n')<CR>
        nnoremap <buffer> <silent> ctM           :<C-U>call feedkeys('ctM','n')<CR>
        nnoremap <buffer> <silent> cTM           :<C-U>call feedkeys('cTM','n')<CR>
        nnoremap <buffer> <silent> cfM           :<C-U>call feedkeys('cfM','n')<CR>
        nnoremap <buffer> <silent> cFM           :<C-U>call feedkeys('cFM','n')<CR>
        nnoremap <buffer> <silent> ctN           :<C-U>call feedkeys('ctN','n')<CR>
        nnoremap <buffer> <silent> cTN           :<C-U>call feedkeys('cTN','n')<CR>
        nnoremap <buffer> <silent> cfN           :<C-U>call feedkeys('cfN','n')<CR>
        nnoremap <buffer> <silent> cFN           :<C-U>call feedkeys('cFN','n')<CR>
        nnoremap <buffer> <silent> ctO           :<C-U>call feedkeys('ctO','n')<CR>
        nnoremap <buffer> <silent> cTO           :<C-U>call feedkeys('cTO','n')<CR>
        nnoremap <buffer> <silent> cfO           :<C-U>call feedkeys('cfO','n')<CR>
        nnoremap <buffer> <silent> cFO           :<C-U>call feedkeys('cFO','n')<CR>
        nnoremap <buffer> <silent> ctP           :<C-U>call feedkeys('ctP','n')<CR>
        nnoremap <buffer> <silent> cTP           :<C-U>call feedkeys('cTP','n')<CR>
        nnoremap <buffer> <silent> cfP           :<C-U>call feedkeys('cfP','n')<CR>
        nnoremap <buffer> <silent> cFP           :<C-U>call feedkeys('cFP','n')<CR>
        nnoremap <buffer> <silent> ctQ           :<C-U>call feedkeys('ctQ','n')<CR>
        nnoremap <buffer> <silent> cTQ           :<C-U>call feedkeys('cTQ','n')<CR>
        nnoremap <buffer> <silent> cfQ           :<C-U>call feedkeys('cfQ','n')<CR>
        nnoremap <buffer> <silent> cFQ           :<C-U>call feedkeys('cFQ','n')<CR>
        nnoremap <buffer> <silent> ctR           :<C-U>call feedkeys('ctR','n')<CR>
        nnoremap <buffer> <silent> cTR           :<C-U>call feedkeys('cTR','n')<CR>
        nnoremap <buffer> <silent> cfR           :<C-U>call feedkeys('cfR','n')<CR>
        nnoremap <buffer> <silent> cFR           :<C-U>call feedkeys('cFR','n')<CR>
        nnoremap <buffer> <silent> ctS           :<C-U>call feedkeys('ctS','n')<CR>
        nnoremap <buffer> <silent> cTS           :<C-U>call feedkeys('cTS','n')<CR>
        nnoremap <buffer> <silent> cfS           :<C-U>call feedkeys('cfS','n')<CR>
        nnoremap <buffer> <silent> cFS           :<C-U>call feedkeys('cFS','n')<CR>
        nnoremap <buffer> <silent> ctT           :<C-U>call feedkeys('ctT','n')<CR>
        nnoremap <buffer> <silent> cTT           :<C-U>call feedkeys('cTT','n')<CR>
        nnoremap <buffer> <silent> cfT           :<C-U>call feedkeys('cfT','n')<CR>
        nnoremap <buffer> <silent> cFT           :<C-U>call feedkeys('cFT','n')<CR>
        nnoremap <buffer> <silent> ctU           :<C-U>call feedkeys('ctU','n')<CR>
        nnoremap <buffer> <silent> cTU           :<C-U>call feedkeys('cTU','n')<CR>
        nnoremap <buffer> <silent> cfU           :<C-U>call feedkeys('cfU','n')<CR>
        nnoremap <buffer> <silent> cFU           :<C-U>call feedkeys('cFU','n')<CR>
        nnoremap <buffer> <silent> ctV           :<C-U>call feedkeys('ctV','n')<CR>
        nnoremap <buffer> <silent> cTV           :<C-U>call feedkeys('cTV','n')<CR>
        nnoremap <buffer> <silent> cfV           :<C-U>call feedkeys('cfV','n')<CR>
        nnoremap <buffer> <silent> cFV           :<C-U>call feedkeys('cFV','n')<CR>
        nnoremap <buffer> <silent> ctW           :<C-U>call feedkeys('ctW','n')<CR>
        nnoremap <buffer> <silent> cTW           :<C-U>call feedkeys('cTW','n')<CR>
        nnoremap <buffer> <silent> cfW           :<C-U>call feedkeys('cfW','n')<CR>
        nnoremap <buffer> <silent> cFW           :<C-U>call feedkeys('cFW','n')<CR>
        nnoremap <buffer> <silent> ctX           :<C-U>call feedkeys('ctX','n')<CR>
        nnoremap <buffer> <silent> cTX           :<C-U>call feedkeys('cTX','n')<CR>
        nnoremap <buffer> <silent> cfX           :<C-U>call feedkeys('cfX','n')<CR>
        nnoremap <buffer> <silent> cFX           :<C-U>call feedkeys('cFX','n')<CR>
        nnoremap <buffer> <silent> ctY           :<C-U>call feedkeys('ctY','n')<CR>
        nnoremap <buffer> <silent> cTY           :<C-U>call feedkeys('cTY','n')<CR>
        nnoremap <buffer> <silent> cfY           :<C-U>call feedkeys('cfY','n')<CR>
        nnoremap <buffer> <silent> cFY           :<C-U>call feedkeys('cFY','n')<CR>
        nnoremap <buffer> <silent> ctZ           :<C-U>call feedkeys('ctZ','n')<CR>
        nnoremap <buffer> <silent> cTZ           :<C-U>call feedkeys('cTZ','n')<CR>
        nnoremap <buffer> <silent> cfZ           :<C-U>call feedkeys('cfZ','n')<CR>
        nnoremap <buffer> <silent> cFZ           :<C-U>call feedkeys('cFZ','n')<CR>
        nnoremap <buffer> <silent> ct[           :<C-U>call feedkeys('ct[','n')<CR>
        nnoremap <buffer> <silent> cT[           :<C-U>call feedkeys('cT[','n')<CR>
        nnoremap <buffer> <silent> cf[           :<C-U>call feedkeys('cf[','n')<CR>
        ...
        nnoremap <buffer> <silent> cf^           :<C-U>call feedkeys('cf^','n')<CR>
        nnoremap <buffer> <silent> cF^           :<C-U>call feedkeys('cF^','n')<CR>
        nnoremap <buffer> <silent> ct_           :<C-U>call feedkeys('ct_','n')<CR>
        nnoremap <buffer> <silent> cT_           :<C-U>call feedkeys('cT_','n')<CR>
        nnoremap <buffer> <silent> cf_           :<C-U>call feedkeys('cf_','n')<CR>
        nnoremap <buffer> <silent> cF_           :<C-U>call feedkeys('cF_','n')<CR>
        nnoremap <buffer> <silent> ct`           :<C-U>call feedkeys('ct`','n')<CR>
        nnoremap <buffer> <silent> cT`           :<C-U>call feedkeys('cT`','n')<CR>
        nnoremap <buffer> <silent> cf`           :<C-U>call feedkeys('cf`','n')<CR>
